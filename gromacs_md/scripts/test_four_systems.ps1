# ============================================================
# AChE & A-beta Four Systems 10,000 Steps Automation Suite (PowerShell)
#
...
Write-Host " Starting 4-System (alllhrc, fllhttr, ylsllqr, ache) 10000-Step MD Suite" -ForegroundColor Green
Write-Host "====================================================================" -ForegroundColor Green

foreach ($Sys in $Systems) {
    Write-Host ""
    Write-Host "====================================================================" -ForegroundColor Cyan
    Write-Host " Processing System: $Sys (10000-Step Validation)" -ForegroundColor Cyan
    Write-Host "====================================================================" -ForegroundColor Cyan
